...
class Dataset(object):
    ...
    def read(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE, img_channels=3, nb_classes=2):
        images, labels = extract_data('/Users/gushixin/Desktop/OwnerSensor/faceOnly/')
        labels = np.reshape(labels, [-1]) # align into one line
        # numpy.reshape
        ...
        # judge the channel, the 'th' means the first channel
...
class Model(object):
    ...
    FILE_PATH = '/Users/gushixin/Desktop/OwnerSensor/store/model.h5' # find the model parameters
